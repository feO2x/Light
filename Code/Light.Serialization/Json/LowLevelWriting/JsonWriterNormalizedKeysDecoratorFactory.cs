...
{
    public sealed class JsonWriterNormalizedKeysDecoratorFactory : IJsonWriterFactory
    {
        ...
        public IJsonWriter Create()
        {
            ...
            return new JsonWriterNormalizedKeysDecorator(new JsonWriter(_stringWriter, _jsonFormatter, _jsonWriterSymbols));
        }
