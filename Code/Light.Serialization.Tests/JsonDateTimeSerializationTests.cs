    ...
    public sealed class JsonDateTimeSerializationTests : BaseDefaultJsonSerializerTest
    {
        ...
        public static readonly TestData UtcTestData =
            new[]
            {
                ...
                new object[] { new DateTime(2016, 2, 2, 13, 54, 50, 300, DateTimeKind.Utc), "\"2016-02-02T13:54:50.300Z\"" },
        ...
        {
            var primitiveFormatters = new List<IPrimitiveTypeFormatter>().AddDefaultPrimitiveTypeFormatters(new DefaultCharacterEscaper());
            primitiveFormatters.OfType<DateTimeFormatter>().Single().TimeZoneInfo = TimeZoneInfo.FindSystemTimeZoneById("W. Europe Standard Time");
            JsonSerializer = new JsonSerializerBuilder().WithWriterInstructors(new List<IJsonWriterInstructor>().AddDefaultWriterInstructors(primitiveFormatters.ToDictionary(f => f.TargetType),
                                                                                                                                             new ValueProvidersCacheDecorator(new PublicPropertiesAndFieldsAnalyzer(), new Dictionary<Type, IList<IValueProvider>>())))
                                                        .Build();
        ...
        public static readonly TestData LocalTestData =
            new[]
            {
                ...
                new object[] { new DateTime(2016, 2, 2, 13, 56, 25, 780, DateTimeKind.Local), "\"2016-02-02T13:56:25.780+01\"" },
                new object[] { new DateTime(2016, 6, 15, 12, 0, 0, DateTimeKind.Local), "\"2016-06-15T12:00+02\"" },
                new object[] { new DateTime(2016, 6, 15, 0, 34, 3, 350, DateTimeKind.Local), "\"2016-06-15T00:34:03.350+02\"" }
            };
        ...
        public static readonly TestData UnspecifiedTestData =
            new[]
            {
                ...
                new object[] { new DateTime(2016, 2, 2, 13, 57, 0, 100, DateTimeKind.Unspecified), "\"2016-02-02T13:57:00.100\"" },
                new object[] { new DateTime(2016, 2, 2, 13, 57, 0, 45, DateTimeKind.Unspecified), "\"2016-02-02T13:57:00.045\"" }
            };
    }
}