    ...
    public sealed class JsonDictionaryDeserializationTests : BaseJsonDeserializerTest
    {
        ...
        public static readonly TestData DeserializeStringDictionariesData =
            new[]
            {
                ...
                new object[] { "{\"$id\":0,\"1\":\"Hey\",\"2\":\"Ho!\",\"3\":\"What?\"}", new Dictionary<string, string> { ["1"] = "Hey", ["2"] = "Ho!", ["3"] = "What?" } }
            };
        ...
        public static readonly TestData UseAbstractionsData =
            new[]
            {
                new object[]
                {
                    "{\"$id\":0,\"$type\":{\"name\":\"genericMap\",\"typeArguments\":[\"string\",\"string\"]}, \"1\": \"Hello\", \"2\": \"World\"}",
                    new Dictionary<string, string> { ["1"] = "Hello", ["2"] = "World" }
                },
                new object[]
                {
                    "{\"$id\":0,\"$type\":{\"name\":\"genericMap\",\"typeArguments\":[\"string\",\"string\"]}, \"This\": \"That\", \"Here\": \"There\"}",
        ...
        public static readonly TestData EnumKeysData =
            new[]
            {
                new object[]
                {
                    "{\"$id\":0,\"$type\":{\"name\":\"genericMap\",\"typeArguments\":[\"ConsoleColor\",\"string\"]}, \"Black\": \"black\", \"Cyan\": \"cyan\", \"DarkMagenta\": \"darkMagenta\"}",
                ...
                new object[]
                {
                    "{\"$id\":0,\"$type\":{\"name\":\"genericMap\",\"typeArguments\":[\"CollectionBehavior\",\"string\"]}, \"CollectionPerAssembly\": \"run tests per assembly\", \"CollectionPerClass\": \"run tests per class\"}",
        ...
        public static readonly TestData NumericKeysData =
            new[]
            {
                new object[]
                {
                    "{\"$id\":0,\"$type\":{\"name\":\"genericMap\",\"typeArguments\":[\"int32\",\"object\"]}, \"1\": \"Hello\", \"2\": \"World\"}",
                    new Dictionary<int, object> { [1] = "Hello", [2] = "World" }, new int()
                },
                new object[]
                {
                    "{\"$id\":0,\"$type\":{\"name\":\"genericMap\",\"typeArguments\":[\"int16\",\"object\"]}, \"-14\": \"x\", \"0\": 19 }",
                    new Dictionary<short, object> { [-14] = "x", [0] = 19 }, new short()
                },
                new object[]
                {
                    "{\"$id\":0,\"$type\":{\"name\":\"genericMap\",\"typeArguments\":[\"int64\",\"object\"]}, \"1\": \"Black\", \"2\": \"DarkBlue\", \"3\": \"Magenta\"}",
                ...
                new object[]
                {
                    "{\"$id\":0,\"$type\":{\"name\":\"genericMap\",\"typeArguments\":[\"uint32\",\"object\"]}, \"1\": \"Hello\", \"2\": \"There\"}",
                    new Dictionary<uint, object> { [1u] = "Hello", [2u] = "There" }, new uint()
                },
                new object[]
                {
                    "{\"$id\":0,\"$type\":{\"name\":\"genericMap\",\"typeArguments\":[\"uint16\",\"object\"]}, \"30000\": \"number\", \"65535\": \"large number\"}",
                    new Dictionary<ushort, object> { [30000] = "number", [65535] = "large number" }, new ushort()
                },
                new object[]
                {
                    $"{{\"$id\":0,\"$type\":{{\"name\":\"genericMap\",\"typeArguments\":[\"uint64\",\"object\"]}}, \"{ulong.MinValue}\": \"long minimum\", \"{ulong.MaxValue}\": \"long maximum\"}}",
                    new Dictionary<ulong, object> { [ulong.MinValue] = "long minimum", [ulong.MaxValue] = "long maximum" }, new ulong()
                },
                new object[]
                {
                    "{\"$id\":0,\"$type\":{\"name\":\"genericMap\",\"typeArguments\":[\"byte\",\"object\"]}, \"1\": \"small byte\", \"2\": \"slightly larger byte\", \"255\": \"largest byte\"}",
                    new Dictionary<byte, object> { [1] = "small byte", [2] = "slightly larger byte", [255] = "largest byte" }, new byte()
                },
                new object[]
                {
                    "{\"$id\":0,\"$type\":{\"name\":\"genericMap\",\"typeArguments\":[\"float64\",\"object\"]}, \"42.7\": \"nearly the answer\", \"42.0\": \"that's it\"}",
                    new Dictionary<double, object> { [42.7] = "nearly the answer", [42.0] = "that's it" }, new double()
                },
                new object[]
                {
                    "{\"$id\":0,\"$type\":{\"name\":\"genericMap\",\"typeArguments\":[\"float32\",\"object\"]}, \"-42.7\": \"nearly the answer\", \"42.0\": \"that's it\"}",
                    new Dictionary<float, object> { [-42.7f] = "nearly the answer", [42.0f] = "that's it" }, new float()
                },
                new object[]
                {
                    "{\"$id\":0,\"$type\":{\"name\":\"genericMap\",\"typeArguments\":[\"decimal\",\"object\"]}, \"-4200.705\": \"nearly the answer\", \"42.0\": \"that's it\"}",
